...
},{"base64-js":5,"ieee754":31,"isarray":9}],9:[function(require,module,exports){
...
},{"./transport":14,"./transports/index":15,"component-emitter":21,"debug":22,"engine.io-parser":25,"indexof":32,"parseqs":34,"parseuri":35}],14:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":14,"component-inherit":11,"debug":22,"engine.io-parser":25,"parseqs":34,"xmlhttprequest-ssl":20,"yeast":54}],19:[function(require,module,exports){
(function (Buffer){
/**
 * Module dependencies.
 */
...
},{"../transport":14,"buffer":8,"component-inherit":11,"debug":22,"engine.io-parser":25,"parseqs":34,"ws":7,"yeast":54}],20:[function(require,module,exports){
...
},{"./on":39,"./socket":40,"backo2":3,"component-bind":10,"component-emitter":42,"debug":43,"engine.io-client":12,"indexof":32,"socket.io-parser":47}],39:[function(require,module,exports){
...
},{"./on":39,"component-bind":10,"component-emitter":42,"debug":43,"has-binary2":28,"parseqs":34,"socket.io-parser":47,"to-array":53}],41:[function(require,module,exports){
...
},{"./common":44,"_process":36,"dup":22}],44:[function(require,module,exports){
...
},{"./binary":46,"./is-buffer":48,"component-emitter":49,"debug":50,"isarray":52}],48:[function(require,module,exports){
(function (Buffer){
...
},{"./debug":51,"_process":36}],51:[function(require,module,exports){
...
},{"ms":33}],52:[function(require,module,exports){
arguments[4][9][0].apply(exports,arguments)
...
function vEmitDataToServer(oData)
{
  oIoConnection.emit(sChannel, oData);
}

function vStatusController(oGameData)
{
  switch(oGameData.iStatus)
  {
    case 0:
      vStatusWaiting(oGameData);
      break;
    case 1:
      vStatusBetting(oGameData);
      break;
    case 2:
      vStatusDealing(oGameData);
      break;
    case 3:
...
{
  var sTagId = "#user";
  vSetCards(sTagId,oUserData);
}

function vSetPlayerCards(oUserData,iPosition)
{
  var sTagId = "#player"+iPosition;
  vSetCards(sTagId,oUserData);
}
...
function vStatusBetting(oGameData)
{
  ...
  if(oGameData.aUserInfoList[iUserPos].iBetAmount==0 && $("#dobet").length==0)
  {
    var sHtml = '<table>'+
                  ...
                  '<tr>'+
                    '<td>'+
                      '<button id="dobet" >下注</button>'+
                    '</td>'+
                  '</tr>'+
                '</table>';
    $(".controlarea").append(sHtml);
    $('body').on("click", '#dobet', function () {
      vBet();
    });
  }
}
...
{
  $("#banker").find(".pointarea").text(sMessage);
}
...
function vSetPlayerPosition(oUserData,iPosition)
{
  var sTagId = "#player"+iPosition;
  vSetPosition(sTagId,oUserData);
}
...
function sGetCardItem(iCode)
{
  var iItem = parseInt(iCode)%13;
  if(iItem == 0)
  {
    return "K";
  }
