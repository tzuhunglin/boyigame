			...
			<div class="content">
				...
				<form action="#" method="post">
					...
					<div class="field half">
						...
						<input name="passwordconfirm" id="passwordconfirm" type="password" placeholder="passwordconfirm">
					</div>
					<div class="field">
						<label for="keeppoint">下級保留返點</label>
						<div class="select-wrapper">
							<select name="keeppoint" id="keeppoint">
								@for ($i = 0; $i < Auth::user()->keeppoint; $i++)
...
var sPostUrl = "{{App\Libraries\Manage\ChildrenLib::sGetCreateLink()}}" ;
